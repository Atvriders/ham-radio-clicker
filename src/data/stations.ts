...
export const stations: Station[] = [
  ...
  },
  {
    id: 'base_station',
    name: 'Base Station',
    description: 'A proper 100-watt HF transceiver on your desk.',
  ...
  },
  {
    ...
    description: 'A 1500-watt amplifier. Because 100 watts is for QRP operators.',
  ...
  },
  {
    id: 'beam_antenna',
    name: 'Beam Antenna',
    description: 'A directional Yagi antenna that puts your signal where it counts.',
  ...
  },
  {
    id: 'tower_steppir',
    name: 'Tower + SteppIR',
    description: 'A 70-foot tower with a SteppIR antenna that covers every band.',
  ...
  },
  {
    id: 'remote_station',
    name: 'Remote Station',
    description: 'A remotely operated station on a mountaintop with zero RFI.',
  ...
  },
  {
    id: 'eme_moonbounce',
    name: 'EME (Moonbounce)',
    description: 'Bounce signals off the Moon. Yes, the actual Moon.',
  ...
  },
  {
    ...
    description: 'A multi-multi contest station with six operating positions.',
