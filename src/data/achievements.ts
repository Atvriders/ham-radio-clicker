...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: 'licensed_tech',
    name: 'Technician',
    description: 'Earn your Technician license.',
    flavor: 'You passed the 35-question test. The VEs smiled. You can now legally transmit. Try not to kerchunk too many repeaters.',
    icon: '📜',
    condition: { type: 'total_qsos', value: 50 },
    hidden: false,
  },
  {
    id: 'ragchewer',
  ...
  },
  {
    id: 'licensed_general',
    name: 'General Class',
    description: 'Earn your General license and unlock HF.',
    flavor: 'You memorized the entire question pool and can now explain impedance matching at parties. Nobody invites you to parties anymore.',
    icon: '📜',
  ...
  },
  {
    id: 'pota_hunter',
    name: 'POTA Hunter',
    description: 'Chase park activators across the country.',
    flavor: 'You\'ve hunted so many parks you can identify them by their repeater frequencies. The national park system thanks you for your support.',
    icon: '🌲',
    condition: { type: 'total_qsos', value: 25_000 },
    hidden: false,
  },
  {
    id: 'five_band_dxcc',
  ...
  {
    id: 'licensed_extra',
    name: 'Extra Class Operator',
    description: 'Earn Extra Class and access all amateur frequencies.',
    flavor: 'You can now operate on the exclusive Extra sub-bands. The code test is gone, but the bragging rights remain.',
    icon: '🎓',
    condition: { type: 'total_qsos', value: 50_000 },
    hidden: false,
  },
  ...
  },
  {
    id: 'dx_chaser',
    name: 'DX Chaser',
    description: 'Chase rare DX entities around the globe.',
    flavor: 'You wake up at 3 AM for grayline openings and have DX cluster alerts on your phone. Your family thinks you have a problem. They\'re right.',
    icon: '🌐',
    condition: { type: 'total_qsos', value: 150_000 },
    hidden: false,
  },
  {
    id: 'extra_class_achievement',
    name: 'Extra Class',
    description: 'Make 200,000 total QSOs — you\'ve earned Extra privileges.',
    flavor: 'You can now operate on the exclusive Extra sub-bands. The code test is gone, but the bragging rights remain.',
    icon: '🎓',
    condition: { type: 'total_qsos', value: 200_000 },
    hidden: false,
  },
  {
    id: 'contester',
    name: 'Contester',
    description: 'Make 500,000 total QSOs.',
    flavor: 'CQ TEST CQ TEST. Your exchange is automatic. You dream in serial numbers. Sleep is a myth. You love it.',
    icon: '🎯',
  ...
  },
  {
    id: 'rubber_duck',
    name: 'Rubber Duck',
    description: 'Own 10 Handheld radios.',
    flavor: 'You have ten HTs with rubber duck antennas. You\'re basically a walking repeater site with the range of a garage door opener.',
    icon: '🦆',
    condition: { type: 'station_owned', stationId: 'handheld', count: 10 },
    hidden: false,
  },
  {
    id: 'lid',
    name: 'Lid',
    description: 'Let your SWR climb above 7.0.',
    flavor: 'You transmitted into a mismatched antenna and your finals are screaming. The old-timers on 75 meters are shaking their heads.',
    icon: '🪣',
